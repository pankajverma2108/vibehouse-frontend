...
## Overview
Vibe House uses **PostgreSQL 17** as the primary relational database. This document captures the full setup, credentials, connection details, and how to manage the database going forward.
