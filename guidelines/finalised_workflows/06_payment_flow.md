...
## Overview
All The Daily Social payments go through **Razorpay** and are processed as a strict **prepaid flow** — no service or commodity is fulfilled until payment is 100% confirmed via webhook. After payment, charges are synced to the eZee PMS folio via the Ops Task Worker.
