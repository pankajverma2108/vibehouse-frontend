  ...
  return (
    <main className="min-h-[100dvh] bg-[#07070a] px-4 py-10 text-white sm:px-6 sm:py-14">
      <div className="mx-auto w-full max-w-[900px]">
        ...
        <p className="mt-3 max-w-2xl text-base leading-7 text-white/64">These exact allowlisted tokens use contract-valid sample data and never call the backend. Submit and Skip open sample results without saving anything. All other tokens continue through normal backend validation.</p>
