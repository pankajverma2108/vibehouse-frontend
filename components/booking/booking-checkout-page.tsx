...
function tabButtonClasses(isActive: boolean, isComplete: boolean) {
  if (isActive) {
    return "bg-[#FF2E62] text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438]";
  }
  if (isComplete) {
    return "bg-[#3BFFAD] text-black border border-[#3BFFAD] shadow-[3px_3px_0px_#000000]";
  }

  return "bg-[#171822] text-white/45 border border-white/10";
}
...
export function BookingCheckoutPage() {
    ...
    return (
      <section className="vh-section min-h-screen pt-28 md:pt-32">
        <div className="mx-auto w-full max-w-[1200px] px-4 md:px-6 lg:px-10">
          <div className="rounded-none border border-white/10 bg-[#171822] p-8 text-center shadow-[6px_6px_0px_#991438]">
            ...
            <Button asChild className="mt-6 rounded-none bg-[#FF2E62] px-6 font-bold text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438] hover:bg-[#FF426F]">
  ...
  const bookingSummaryDesktop = (
    <aside className="relative hidden self-start lg:sticky lg:top-28 lg:block">
      <div className="rounded-none border border-white/10 bg-[#171822] shadow-[6px_6px_0px_#991438]">
        <div className="p-6">
          <h2 className="font-['Cirka',serif] text-[22px] tracking-tight text-white">Booking details</h2>

          <div className="mt-5 grid grid-cols-[1fr_auto_1fr] items-center gap-3 rounded-none border border-white/10 bg-[#12131A] px-4 py-4">
            <div>
            ...
            <div className="rounded-none bg-[#FF2E62] px-2 py-1 text-[10px] font-bold uppercase text-white border border-[#FF2E62] shadow-[2px_2px_0px_#991438]">
          ...
          <div className="mt-5 space-y-2 border-t border-white/10 pt-4 text-sm text-white/82">
            ...
            <div className="space-y-3 border-t border-white/10 pt-3">
              ...
              {activeAddons.length === 0 ? (
                <p className="rounded-none border border-dashed border-white/10 bg-[#12131A] px-3 py-3 text-xs text-white/55">
                  No extras added yet.
                </p>
              ) : (
                activeAddons.map((addon) => (
                  <div key={addon.productId} className="flex items-start justify-between gap-3 rounded-none border border-white/10 bg-[#12131A] px-3 py-3">
                    <div>
            ...
            <div className="flex items-center justify-between">
              <p className="font-body inline-flex items-center gap-1">
                ...
                <span className="group relative inline-flex">
                  ...
                  <span className="pointer-events-none absolute left-0 top-[calc(100%+8px)] hidden min-w-[220px] rounded-none border border-white/10 bg-[#12131A] px-3 py-2 text-[11px] leading-4 text-white/85 shadow-[0_10px_28px_rgba(0,0,0,0.35)] group-hover:block">
        ...
        <div className="p-6 pt-4">
          ...
          {activeTab === "guest" ? (
            <button
              className="inline-flex h-12 w-full items-center justify-center rounded-none bg-[#FF2E62] px-6 font-bold text-white border border-[#FF2E62] shadow-[4px_4px_0px_#991438] hover:bg-[#FF426F] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all text-base"
            ...
            <Button
              className="inline-flex h-12 w-full items-center justify-center rounded-none bg-[#FF2E62] px-6 font-bold text-white border border-[#FF2E62] shadow-[4px_4px_0px_#991438] hover:bg-[#FF426F] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all text-base disabled:cursor-not-allowed disabled:opacity-60"
              disabled={isPaying}
              loading={isPaying}
  ...
  const eventCta = (
    <div className="rounded-none border border-white/10 bg-[#171822] p-5 shadow-[6px_6px_0px_#991438]">
      <div className="flex items-start gap-4">
        <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-none border border-white/10 bg-[#12131A] text-[#FF2E62] shadow-[3px_3px_0px_#991438]">
          <PartyPopper className="h-8 w-8" strokeWidth={2.2} />
        </div>
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#FF2E62]">Events</p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row">
            <Link className="inline-flex h-11 items-center justify-center rounded-none bg-[#FF2E62] px-5 font-bold text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438] hover:bg-[#FF426F] sm:w-auto" href="/events">
              Explore events
            </Link>
            <Link className="inline-flex items-center justify-center rounded-none border border-white/15 bg-[#12131A] px-5 py-3 text-sm font-bold uppercase tracking-[0.08em] text-white hover:bg-[#1E1F2D] sm:w-auto" href="/events?tab=rsvp">
              RSVP board
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0E] pb-28 text-white lg:pb-12">
      <section className="mx-auto w-full max-w-[1200px] px-4 pb-8 pt-20 md:px-6 md:pb-12 md:pt-24">
              ...
              return (
                <div key={tab.key} className="relative flex flex-col items-center gap-3">
                  {index < reviewTabs.length - 1 ? (
                    <div className={`absolute left-[calc(50%+28px)] top-6 hidden h-[2px] w-[calc(100%-56px)] md:block ${activeTab !== "guest" && index === 0 ? "bg-[#FF2E62]" : "bg-white/10"}`} />
                  ) : null}
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
          <div className="space-y-6">
            {activeTab === "guest" ? (
              <>
                <div className="overflow-hidden rounded-none border border-white/10 bg-[#171822] shadow-[6px_6px_0px_#991438]">
                  <div className="p-6 md:p-8">
                    <div className="mb-6 flex items-start justify-between gap-4">
                      ...
                      {!isAuthenticated ? (
                        <button
                          className="rounded-none border border-white/15 bg-[#12131A] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.12em] text-white hover:bg-[#1E1F2D]"
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                      <label className="block">
                        ...
                        <input
                          ...
                          className={`w-full rounded-none border bg-[#12131A] px-4 py-4 text-base text-white outline-none focus:border-[#FF2E62] ${guestErrors.firstName ? "border-[#EE4D37]" : "border-white/10"}`}
                      ...
                      <label className="block">
                        ...
                        <input
                          ...
                          className={`w-full rounded-none border bg-[#12131A] px-4 py-4 text-base text-white outline-none focus:border-[#FF2E62] ${guestErrors.lastName ? "border-[#EE4D37]" : "border-white/10"}`}
                      ...
                      <label className="block">
                        ...
                        <input
                          autoComplete="email"
                          className={`w-full rounded-none border bg-[#12131A] px-4 py-4 text-base text-white outline-none focus:border-[#FF2E62] ${guestErrors.email ? "border-[#EE4D37]" : "border-white/10"}`}
                      ...
                      <label className="block">
                        ...
                        <input
                          autoComplete="tel"
                          className={`w-full rounded-none border bg-[#12131A] px-4 py-4 text-base text-white outline-none focus:border-[#FF2E62] ${guestErrors.phone ? "border-[#EE4D37]" : "border-white/10"}`}
                          inputMode="tel"
                    ...
                    {guestForm.additionalGuests.length > 0 ? (
                      <div className="mt-6 rounded-none border border-white/10 bg-[#12131A] p-4">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="rounded-none border border-white/10 bg-[#171822] px-3 py-1 text-[11px] font-mono uppercase tracking-[0.12em] text-white/55">
                            Optional
                          </div>
                        </div>
                        ...
                        <div className="mt-4 space-y-4">
                          {guestForm.additionalGuests.map((additionalGuest, index) => (
                            <div key={`additional-guest-${index}`} className="rounded-none border border-white/10 bg-[#171822] p-4">
                              ...
                              <div className="mt-3 grid gap-4 md:grid-cols-2">
                                <label className="block">
                                  ...
                                  <input
                                    className="w-full rounded-none border border-white/10 bg-[#12131A] px-4 py-3 text-sm text-white outline-none focus:border-[#FF2E62]"
                    ...
                    <div className={`mt-6 rounded-none border p-4 ${guestErrors.acceptedTerms ? "border-[#EE4D37] bg-[#EE4D37]/5" : "border-white/10 bg-[#12131A]"}`}>
                      <label className="flex items-start gap-3">
                        <input
                          checked={guestForm.acceptedTerms}
                          className="mt-1 h-4 w-4 accent-[#FF2E62] rounded-none"
                        ...
                        <span className="text-sm leading-6 text-white/80">
                          ...
                          <Link className="text-[#FF2E62] hover:underline" href="/policies">
                ...
                <div className="overflow-hidden rounded-none border border-white/10 bg-[#171822] shadow-[6px_6px_0px_#991438]">
                  <div className="p-6 md:p-8">
                    ...
                    <div className="mt-5 flex gap-3">
                      <input
                        className="flex-1 rounded-none border border-white/10 bg-[#12131A] px-4 py-4 text-base text-white outline-none focus:border-[#FF2E62]"
                        onChange={(event) => handleCouponInputChange(event.target.value)}
                        placeholder="Have a coupon code?"
                        value={guestForm.coupon}
                      />
                      <button
                        className="rounded-none bg-[#FF2E62] px-5 text-sm font-bold uppercase tracking-[0.08em] text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438] hover:bg-[#FF426F] disabled:cursor-not-allowed disabled:opacity-50"
                    ...
                    <div className="mt-5 space-y-3">
                      {PROMO_CODES.map((coupon) => (
                        <button
                          key={coupon.code}
                          className={`block w-full rounded-none border p-4 text-left ${guestForm.coupon === coupon.code ? "border-[#FF2E62] bg-[#1E0A10] shadow-[3px_3px_0px_#991438]" : "border-white/10 bg-[#12131A] hover:bg-[#1E1F2D]"}`}
                ...
                <div className="overflow-hidden rounded-none border border-white/10 bg-[#171822] shadow-[6px_6px_0px_#991438]">
                  <div className="p-6 md:p-8">
                    ...
                    {catalogLoading ? (
                      <div aria-busy="true" aria-live="polite" className="mt-5 space-y-3" role="status">
                        {Array.from({ length: 3 }).map((_, index) => (
                          <div key={`catalog-loading-${index}`} className="flex items-center justify-between rounded-none border border-white/10 bg-[#12131A] px-4 py-4">
                            <div className="flex min-w-0 items-center gap-4">
                              <Skeleton className="h-12 w-12 rounded-none border border-white/10 bg-white/10" />
                              <div className="min-w-0 space-y-2">
                                <Skeleton className="h-4 w-44 bg-white/10" />
                                <Skeleton className="h-3 w-28 bg-white/10" />
                              </div>
                            </div>
                            <Skeleton className="h-9 w-20 rounded-none border border-white/10 bg-white/10" />
                          </div>
                        ))}
                      </div>
                    ) : null}
                    ...
                    {!catalogLoading && commodityItems.length === 0 ? (
                      <div className="mt-5 rounded-none border border-dashed border-white/10 bg-[#12131A] px-4 py-5 text-sm text-white/70">
                      ...
                      {commodityItems.map((item) => {
                        ...
                        return (
                          <div key={item.id} className={`flex items-center justify-between gap-4 py-4 ${disabled ? "opacity-55" : ""}`}>
                            <div className="flex min-w-0 items-center gap-4">
                              <div className={`flex h-14 w-14 items-center justify-center rounded-none border border-white/10 ${frameClassName}`}>
                            ...
                            {quantity > 0 ? (
                              <div className="flex items-center gap-3 rounded-none border border-white/10 bg-[#12131A] px-2 py-1">
                                <button className="flex h-8 w-8 items-center justify-center rounded-none border border-white/10 bg-[#171822] text-white hover:bg-[#1E1F2D]" onClick={() => decrementAddon(item)} type="button">
                                  <Minus className="h-4 w-4" />
                                </button>
                                <span className="w-4 text-center text-base font-bold text-white">{quantity}</span>
                                <button className="flex h-8 w-8 items-center justify-center rounded-none border border-white/10 bg-[#171822] text-white hover:bg-[#1E1F2D]" onClick={() => incrementAddon(item)} type="button">
                                  <Plus className="h-4 w-4" />
                                </button>
                              </div>
                            ) : (
                              <button
                                className="rounded-none bg-[#FF2E62] px-5 py-2 text-sm font-bold uppercase tracking-[0.08em] text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438] hover:bg-[#FF426F] disabled:cursor-not-allowed disabled:opacity-50"
                                disabled={disabled}
                          ...
                          <div key={item.id} className="flex items-center justify-between gap-4 py-4">
                            ...
                            {quantity > 0 ? (
                              <div className="flex items-center gap-3 rounded-none border border-white/10 bg-[#12131A] px-2 py-1">
                                ...
                                <span className="w-4 text-center text-base font-bold text-white">{quantity}</span>
                                <button
                                  className="flex h-8 w-8 items-center justify-center rounded-none border border-white/10 bg-[#171822] text-white hover:bg-[#1E1F2D] disabled:cursor-not-allowed disabled:text-white/25 disabled:hover:bg-transparent"
                              ...
                              <button
                                className="rounded-none bg-[#FF2E62] px-5 py-2 text-sm font-bold uppercase tracking-[0.08em] text-white border border-[#FF2E62] shadow-[3px_3px_0px_#991438] hover:bg-[#FF426F]"
                                onClick={() => incrementAddon(item)}
                                type="button"
                              >
                                Add
      ...
      <div className={`fixed inset-0 z-[60] transition ${showMobileSummary ? "pointer-events-auto bg-black/80" : "pointer-events-none bg-transparent"}`}>
        <div className={`absolute bottom-0 left-0 right-0 max-h-[85vh] rounded-none border-t-2 border-[#FF2E62] bg-[#171822] shadow-[0_-10px_30px_rgba(0,0,0,0.8)] transition-transform duration-300 ${showMobileSummary ? "translate-y-0" : "translate-y-full"}`}>
          <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
            ...
            <button className="inline-flex h-9 w-9 items-center justify-center rounded-none border border-white/10 bg-[#12131A] text-white hover:bg-[#1E1F2D]" onClick={() => setShowMobileSummary(false)} type="button">
              <X className="h-4 w-4" />
            </button>
          </div>

          <div className="space-y-4 overflow-y-auto px-5 py-5">
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 rounded-none border border-white/10 bg-[#12131A] px-4 py-4">
              <div>
              ...
              <div className="rounded bg-[#FF2E62] px-2 py-1 text-[10px] font-bold uppercase text-white">
                {stayUnitCount} {stayUnitLabel}
              </div>
              <div className="text-right">
            ...
            <div className="space-y-3">
              <div className="rounded-none border border-white/10 bg-[#12131A] px-4 py-4">
              ...
              {draft.rooms.map((room) => (
                <div key={room.roomTypeId} className="flex items-start justify-between gap-3 rounded-none border border-white/10 bg-[#12131A] px-4 py-4">
                  <div>
            ...
            <div className="space-y-2 rounded-none border border-white/10 bg-[#12131A] px-4 py-4 text-sm text-white/82">
              <div className="flex items-center justify-between">
                <p>Room charges</p>
